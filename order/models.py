...
class Order(models.Model):
    ...
    this_order_client = models.ForeignKey(
        Client,
    ...
    for_other = models.BooleanField(
        default=False,
        verbose_name="Заказ другому")
...
class OrderItem(models.Model):
    """ Field name is needed to store product name,
    in case product gets deleted  """
